...
CAFVE_TOKEN_DIM = 128  # Default CAFVE token dimension
...
class Predict:
    ...
    def __init__(self,
        ...
        self.predictor_network = Sequential(
            Linear(self.prediction_input_dim, 2048),
            ReLU(),
            Linear(2048, self.predicted_output_dim)
        )
...
if __name__ == "__main__":
    logger.info("Predict module loaded successfully.")