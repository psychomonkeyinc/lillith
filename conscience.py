...
class Conscience:
    ...
    def __init__(self,
                 ...
                 tom_perception_dim: int = 512,          # From ToM.py (understanding of others' mental states)
        ...
        self.moral_judgment_network = Sequential(
            Linear(self.moral_eval_input_dim, 256), # Hidden layer
            ReLU(),
            Linear(256, 128),
            ReLU(),
            Linear(128, 1), # Output to a single scalar judgment
...
if __name__ == "__main__":
    logger.info("Conscience module loaded successfully.")